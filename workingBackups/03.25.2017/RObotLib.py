...
def help(args=0):
    ...
    if not args:
        return 'My current working commands are !help, !info, !item, !building, !customer (or !cust), !quest, !search, !klash (or !pvp), !sheets, !gettingStarted (or !gs), and !fwt. For more info on each command, use !help [command]. There is a 3 second timer on commands. For a (mostly) thorough explanation of me: http://www.kongregate.com/forums/304-swords-potions-2/topics/721821'
    else:
...
def fwt():
    ...
    if tier:
        return "Free world trade is active! Trader's guilds level {} and up can use it, {} left. Upcoming FWTs for levels-  1 (1st of the month): {}; 2 (+15th): {}; 3 (+sunday): {}.".format(tier, ttxt0, ttxt1, ttxt2, ttxt3)
    else:
        return "Next free world trade days for trader's guild level- 1 (1st of the month): {}; 2 (+15th): {}; 3 (+sunday): {}.".format(ttxt1, ttxt2, ttxt3)
...
optionDict = {'info':info, 'help':help, 'search':search, 'item':item, 'mindyalts':mindyAlts, 'pvp':pvp, 'klash':pvp,
              ...
              'freeworldtrade':fwt, 'freeworldtradeday':fwt}
