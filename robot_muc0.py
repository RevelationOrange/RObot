...
class MUCBot(sleekxmpp.ClientXMPP):
    ...
    def __init__(self, jid, password, room, nick):
        ...
        # self.add_event_handler("result", self.privateMessage)
        self.register_handler(sleekxmpp.xmlstream.handler.callback.Callback('PrivateHandler',
                                                                            sleekxmpp.xmlstream.matcher.xpath.MatchXPath(
                                                                                '{%s}iq/{%s}query' % (
                                                                                self.default_ns, "kongregate:iq:msg")),
                                                                            self.privateMessage))
