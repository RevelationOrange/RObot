...
room_jid = "243378-shop-heroes-1@conference.of1.kongregate.com"
...
class MUCBot(sleekxmpp.ClientXMPP):
    ...
    def privmessage(self, msg):
        ...
        if tmp is not None:
            ...
            print(resp)
            if sendTo == 'RevelationOrange' or sendTo == 'DataNerd0x00':
                inputs = msgBody.split(' ')
                if inputs[0] == '!say':
                    chatTxt = ' '.join(inputs[1:])
                    resprepl = "<message to='243378-shop-heroes-1@conference.of1.kongregate.com' from='snp2_RObot@of1.kongregate.com/xiff' type='groupchat' id='dc96ae0e-27ec-40e5-83f2-b4a013d5ec0a' xmlns='jabber:client'><body>{}</body><x xmlns='jabber:x:event'><composing/></x></message>"
    ...
    def start(self, event):
        ...
        xmpp.send_raw("<presence from='snp2_robot@of1.kongregate.com/xiff' to='243378-shop-heroes-1@conference.of1.kongregate.com/snp2_RObot' xmlns='jabber:client'><x xmlns='http://jabber.org/protocol/muc'><history seconds='60'/></x><status>[&quot;HsV3o4w4NR4DIGgcsuQHbA==&quot;,&quot;[\&quot;snp2_RObot\&quot;,\&quot;\&quot;,1,\&quot;cdn4:/assets/avatars/defaults/wrestleboy.png?i10c=img.resize(width:16)\&quot;,\&quot;Shop Heroes\&quot;,\&quot;/games/cloudcade/shop-heroes\&quot;,[],[]]&quot;,{&quot;special_chat_vars&quot;:&quot;{}&quot;}]</status></presence>")
